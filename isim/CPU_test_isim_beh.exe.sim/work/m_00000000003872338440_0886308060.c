...
#endif
static const char *ng0 = "F:/workspace/FinishedProjects/CPUSingleCycle/ALU.v";
static int ng1[] = {0, 0};
...
LAB99:    if (*((unsigned int *)t244) < *((unsigned int *)t245))
        goto LAB97;
...
LAB109:    t325 = *((unsigned int *)t254);
    t326 = (~(t325));
    t327 = *((unsigned int *)t280);
    t328 = (t326 || t327);
    if (t328 > 0)
        goto LAB110;
...
LAB113:    if (*((unsigned int *)t254) > 0)
        goto LAB114;

LAB115:    memcpy(t253, t329, 8);

LAB116:    goto LAB89;

LAB90:    xsi_vlog_unsigned_bit_combine(t213, 32, t246, 32, t253, 32);
    goto LAB94;
...
LAB118:
LAB119:    memset(t284, 0, 8);
    t315 = (t284 + 4);
    t316 = (t288 + 4);
    t317 = *((unsigned int *)t288);
    t318 = (~(t317));
    *((unsigned int *)t284) = t318;
    *((unsigned int *)t315) = 0;
    if (*((unsigned int *)t316) != 0)
        goto LAB121;

LAB120:    t323 = *((unsigned int *)t284);
    *((unsigned int *)t284) = (t323 & 4294967295U);
    t324 = *((unsigned int *)t315);
    *((unsigned int *)t315) = (t324 & 4294967295U);
    goto LAB109;

LAB110:    t329 = ((char*)((ng1)));
    goto LAB111;

LAB112:    xsi_vlog_unsigned_bit_combine(t253, 32, t284, 32, t329, 32);
    goto LAB116;

LAB114:    memcpy(t253, t284, 8);
    goto LAB116;

LAB117:    t299 = *((unsigned int *)t288);
...
LAB121:    t319 = *((unsigned int *)t284);
    t320 = *((unsigned int *)t316);
    *((unsigned int *)t284) = (t319 | t320);
...
extern void work_m_00000000003872338440_0886308060_init()
{
	static char *pe[] = {(void *)Cont_42_0,(void *)Cont_43_1};
	xsi_register_didat("work_m_00000000003872338440_0886308060", "isim/CPU_test_isim_beh.exe.sim/work/m_00000000003872338440_0886308060.didat");
